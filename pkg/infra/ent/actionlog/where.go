...
func ExitedAt(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func Status(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtEQ(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldExitedAt), v))
	})
}
...
func ExitedAtNEQ(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtIn(vs ...int64) predicate.ActionLog {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExitedAtNotIn(vs ...int64) predicate.ActionLog {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExitedAtGT(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtGTE(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtLT(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtLTE(v int64) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtIsNil() predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func ExitedAtNotNil() predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusEQ(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), vc))
	})
...
func StatusNEQ(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusIn(vs ...types.TaskStatus) predicate.ActionLog {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = string(vs[i])
	}
...
func StatusNotIn(vs ...types.TaskStatus) predicate.ActionLog {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = string(vs[i])
	}
...
func StatusGT(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusGTE(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusLT(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusLTE(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusContains(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusHasPrefix(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusHasSuffix(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusEqualFold(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
func StatusContainsFold(v types.TaskStatus) predicate.ActionLog {
	vc := string(v)
	return predicate.ActionLog(func(s *sql.Selector) {
...
// HasArgument applies the HasEdge predicate on the "argument" edge.
func HasArgument() predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ArgumentTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ArgumentTable, ArgumentColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasArgumentWith applies the HasEdge predicate on the "argument" edge with a given conditions (other predicates).
func HasArgumentWith(preds ...predicate.Attribute) predicate.ActionLog {
	return predicate.ActionLog(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ArgumentInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ArgumentTable, ArgumentColumn),
		)
